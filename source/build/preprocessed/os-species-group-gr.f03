# 1 "gr/os-species-group-gr.f03"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 467 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gr/os-species-group-gr.f03" 2
# 1 "./os-config.h" 1
...
# 2 "gr/os-species-group-gr.f03" 2
...
# 3 "gr/os-species-group-gr.f03" 2
...
# 19 "./memory/memory.h"
use memory
# 7 "gr/os-species-group-gr.f03" 2
...
subroutine set_species_group( this, electrons, positrons, photons )
  ...
  select type( electrons )
    ...
    class default
      write(err_buf__,*) 'set_species_group must be called with t_species_gr objects';call err__("gr/os-species-group-gr.f03",446)
  ...
  select type( positrons )
    ...
    class default
      write(err_buf__,*) 'set_species_group must be called with t_species_gr objects';call err__("gr/os-species-group-gr.f03",457)
      call abort_program( p_err_invalid )
  end select
  ...
  select type( photons )
    ...
    class default
      write(err_buf__,*) 'set_species_group must be called with t_species_gr objects';call err__("gr/os-species-group-gr.f03",465)
      call abort_program( p_err_invalid )
  end select
...
subroutine inject_surface_group( this, b, e, dt, no_co )
  ...
  call alloc(ppos_cell, (/p_x_dim, ppcell/),"gr/os-species-group-gr.f03",603)
  ...
  call freemem(ppos_cell,"gr/os-species-group-gr.f03",796)
...
subroutine inject_surface_group_gr( this, b, e, dt, no_co )
  ...
  ! initialize temp buffers
  call alloc(ppos_cell, (/p_x_dim, ppcell/),"gr/os-species-group-gr.f03",861)
  ...
  call freemem(ppos_cell,"gr/os-species-group-gr.f03",1141)
...
subroutine inject_volume_group( this, b, e, dt, no_co )
  ...
  ! initialize temp buffers
  call alloc(ppos_cell, (/p_x_dim, ppcell/),"gr/os-species-group-gr.f03",1197)
  ...
  call freemem(ppos_cell,"gr/os-species-group-gr.f03",1390)
...
subroutine inject_volume_group_gr( this, b, e, dt, no_co )
  ...
  ! initialize temp buffers
  call alloc(ppos_cell, (/p_x_dim, ppcell/),"gr/os-species-group-gr.f03",1449)
  ...
  call freemem(ppos_cell,"gr/os-species-group-gr.f03",1676)
