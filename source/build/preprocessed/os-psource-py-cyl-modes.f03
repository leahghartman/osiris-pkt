# 1 "cyl_modes/psource/os-psource-py-cyl-modes.f03"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 467 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "cyl_modes/psource/os-psource-py-cyl-modes.f03" 2
# 1 "./os-config.h" 1
...
# 2 "cyl_modes/psource/os-psource-py-cyl-modes.f03" 2
...
# 3 "cyl_modes/psource/os-psource-py-cyl-modes.f03" 2
...
# 19 "./memory/memory.h"
use memory
# 7 "cyl_modes/psource/os-psource-py-cyl-modes.f03" 2
...
subroutine load_density_py_cyl_modes( this )
  ...
  do i = 1, p_x_dim
    if (nx(i) <= 1) then
      write(err_buf__,*) 'In load_density_py_cyl_modes, nx must be > 1 in each dimension.';call err__("cyl_modes/psource/os-psource-py-cyl-modes.f03",231)
      write(err_buf__,*) 'Incompatible size of density grid.';call err__("cyl_modes/psource/os-psource-py-cyl-modes.f03",232)
