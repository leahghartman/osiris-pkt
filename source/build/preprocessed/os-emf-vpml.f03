# 1 "emf/boundary/os-emf-vpml.f03"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 467 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "emf/boundary/os-emf-vpml.f03" 2
!
...
# 11 "emf/boundary/os-emf-vpml.f03" 2
...
# 12 "emf/boundary/os-emf-vpml.f03" 2
...
# 19 "./memory/memory.h"
use memory
# 18 "emf/boundary/os-emf-vpml.f03" 2
...
!---------------------------------------------------
   ...
   call freemem(this%dir_vpml,"emf/boundary/os-emf-vpml.f03",181)
   call freemem(this%loc_vpml,"emf/boundary/os-emf-vpml.f03",182)
  ...
  call freemem(this%wall_array_e,"emf/boundary/os-emf-vpml.f03",189)
  call freemem(this%wall_array_b,"emf/boundary/os-emf-vpml.f03",190)

  call freemem(this%pos_corner,"emf/boundary/os-emf-vpml.f03",192)

  call freemem(this%coef_e_low,"emf/boundary/os-emf-vpml.f03",194)
  call freemem(this%coef_b_low,"emf/boundary/os-emf-vpml.f03",195)
  call freemem(this%coef_e_up,"emf/boundary/os-emf-vpml.f03",196)
  call freemem(this%coef_b_up,"emf/boundary/os-emf-vpml.f03",197)
...
!---------------------------------------------------
  ...
  call restart_io_write("p_vpml_rst_id", p_vpml_rst_id, restart_handle, ierr)
  if ( ierr/=0 ) then

    write(err_buf__,*) 'error writing restart data for vpml object.';call err__("emf/boundary/os-emf-vpml.f03",217)
    call abort_program(p_err_rstwrt)
  endif

  call restart_io_write("this%n_vpml", this%n_vpml, restart_handle, ierr)
...
!---------------------------------------------------
   ...
   if ( ierr/=0 ) then
     ...
     write(err_buf__,*) 'error reading restart data for vpml object.';call err__("emf/boundary/os-emf-vpml.f03",247)
     call abort_program(p_err_rstrd)
   endif

   if ( rst_id /= p_vpml_rst_id) then
     write(err_buf__,*) 'Corrupted restart file ';call err__("emf/boundary/os-emf-vpml.f03",252)
     write(err_buf__,*) 'from incompatible binary (vpml)';call err__("emf/boundary/os-emf-vpml.f03",253)
     call abort_program(p_err_rstrd)
   endif

   call restart_io_read(this%n_vpml, restart_handle, ierr)
   if ( ierr/=0 ) then

     write(err_buf__,*) 'error reading restart data for vpml object.';call err__("emf/boundary/os-emf-vpml.f03",260)
     call abort_program(p_err_rstrd)
   endif
...
integer, dimension(2, p_x_dim) :: nx_corner
  ...
  call alloc(this%dir_vpml, (/n_vpml/),"emf/boundary/os-emf-vpml.f03",320)
  call alloc(this%loc_vpml, (/n_vpml/),"emf/boundary/os-emf-vpml.f03",321)
  ...
  call alloc(this%wall_array_e, (/ n_vpml /),"emf/boundary/os-emf-vpml.f03",348)
  call alloc(this%wall_array_b, (/ n_vpml /),"emf/boundary/os-emf-vpml.f03",349)

  ! allocate corner position
  call alloc(this%pos_corner, (/ n_vpml, p_x_dim, 2 /),"emf/boundary/os-emf-vpml.f03",352)
...
!-----------------------------------------------------------------------------------------
   ...
   if ( this % coordinates == p_cylindrical_b ) then
     ! Position of lower axial boundary
     this % gir_pos = new_lb%my_nx( p_lower, 2 )
   endif
...
!-----------------------------------------------------------------------------------------
  ...
  call alloc(this%coef_e_low, (/ p_x_dim,3,thickness /),"emf/boundary/os-emf-vpml.f03",3608)
  call alloc(this%coef_b_low, (/ p_x_dim,3,thickness /),"emf/boundary/os-emf-vpml.f03",3609)
  call alloc(this%coef_e_up, (/ p_x_dim,3,thickness /),"emf/boundary/os-emf-vpml.f03",3610)
  call alloc(this%coef_b_up, (/ p_x_dim,3,thickness /),"emf/boundary/os-emf-vpml.f03",3611)
...
subroutine update_beam_vpml_3d_x2_lower( vpml_b, vpml_e, coef_e_low, coef_e_up, coef_b_low, coef_b_up, dtdx, pos_corner, ef, bf )
  ...
  if (i3_lowercorner < lbound( ef%f3 , 4 )) then
      ...
      write(err_buf__,*) 'Error: x2-lowerVPML-Lower-Corner boundary index < lower boundary of simulation fields in the box';call err__("emf/boundary/os-emf-vpml.f03",4011)
       ...
       do i2 = range(2), range(1), -1
         do i3 = i3_lowercorner - 1, 1 - gc3a, -1
            ...
            if ( (coef_e_cnr_x3(2) == 0.0) .or. (coef_e_cnr_x3(3) == 0.0) .or. (coef_b_cnr_x3(2) == 0.0) .or. (coef_b_cnr_x3(3) == 0.0)) then
               write(err_buf__,*) 'Error: Coefficients for x2-lowerVPML-Lower-Corner are 0, please check the index';call err__("emf/boundary/os-emf-vpml.f03",4030)
            endif
  ...
  if (i3_uppercorner > ubound( ef%f3 , 4 )) then
     ...
     write(err_buf__,*) 'Error: x2-lowerVPML-Upper-Corner boundary index > upper boundary of simulation fields in the box';call err__("emf/boundary/os-emf-vpml.f03",4078)
     ...
     do i1 = 1, ef%nx_(1)
       do i2 = range(2), range(1), -1
         do i3 = i3_uppercorner + 1, vpml_e%nx(3) + gc3b
            ...
            if ( (coef_e_cnr_x3(2) == 0.0) .or. (coef_e_cnr_x3(3) == 0.0) .or. (coef_b_cnr_x3(2) == 0.0) .or. (coef_b_cnr_x3(3) == 0.0)) then
               write(err_buf__,*) 'Error: Coefficients for x2-lowerVPML-Upper-Corner are 0, please check the index';call err__("emf/boundary/os-emf-vpml.f03",4095)
            endif
...
subroutine update_beam_vpml_3d_x2_upper( vpml_b, vpml_e, coef_e_low, coef_e_up, coef_b_low, coef_b_up, dtdx, pos_corner, ef, bf )
  ...
  if (i3_lowercorner < lbound( ef%f3 , 4 )) then
      ...
      write(err_buf__,*) 'Error: x2-upperVPML-Lower-Corner boundary index < lower boundary of simulation fields in the box';call err__("emf/boundary/os-emf-vpml.f03",4250)
      ! If there is such an index gap, the initialization of the fields (at index of i3_lowercorner) is needed
  endif
     ...
     do i1 = 1, ef%nx_(1)
       do i2 = range(1), range(2)
         do i3 = i3_lowercorner - 1, 1 - gc3a, -1
            ...
            if ( (coef_e_cnr_x3(2) == 0.0) .or. (coef_e_cnr_x3(3) == 0.0) .or. (coef_b_cnr_x3(2) == 0.0) .or. (coef_b_cnr_x3(3) == 0.0)) then
               write(err_buf__,*) 'Error: Coefficients for x2-upperVPML-Lower-Corner are 0, please check the index';call err__("emf/boundary/os-emf-vpml.f03",4266)
            endif
  ...
  if (i3_uppercorner > ubound( ef%f3 , 4 )) then
     ...
     write(err_buf__,*) 'Error: x2-upperVPML-Upper-Corner boundary index > upper boundary of simulation fields in the box';call err__("emf/boundary/os-emf-vpml.f03",4312)
  endif
     ...
     do i1 = 1, ef%nx_(1)
       do i2 = range(1), range(2)
         do i3 = i3_uppercorner + 1, vpml_e%nx(3) + gc3b
            ...
            if ( (coef_e_cnr_x3(2) == 0.0) .or. (coef_e_cnr_x3(3) == 0.0) .or. (coef_b_cnr_x3(2) == 0.0) .or. (coef_b_cnr_x3(3) == 0.0)) then
               write(err_buf__,*) 'Error: Coefficients for x2-upperVPML-Upper-Corner are 0, please check the index';call err__("emf/boundary/os-emf-vpml.f03",4327)
            endif
