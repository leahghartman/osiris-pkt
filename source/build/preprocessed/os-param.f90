...
! no. of spatial dimensions. Currently set to the preprocessor macro 1
integer, parameter :: p_x_dim = 1
...
integer, parameter :: c_k_part = c_double
integer, parameter :: c_k_fld = c_double
# 64 "os-param.f90"
!==============================================================
...
integer, parameter :: p_sim_cuda = 16 ! cuda algorithm
integer, parameter :: p_sim_pkt = 17 ! PKT algorithm
...
integer, parameter :: p_gravity = 13 ! Boris pusher with gravity
integer, parameter :: p_std_feedback = 14 ! Boris pusher with ponderomotive feedback from photons
