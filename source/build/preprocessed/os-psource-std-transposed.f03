# 1 "spec/psource/os-psource-std-transposed.f03"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 467 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "spec/psource/os-psource-std-transposed.f03" 2
# 1 "./os-config.h" 1
...
# 2 "spec/psource/os-psource-std-transposed.f03" 2
...
# 3 "spec/psource/os-psource-std-transposed.f03" 2
...
# 19 "./memory/memory.h"
use memory
# 7 "spec/psource/os-psource-std-transposed.f03" 2
...
function inject_std_transposed( this, species, ig_xbnd_inj, jay, no_co, bnd_cross, node_cross, &
  ...
  call alloc(ppos, (/p_x_dim, ncells_total * ppcell/),"spec/psource/os-psource-std-transposed.f03",115)
  call alloc(pidx, (/p_x_dim, ncells_total * ppcell/),"spec/psource/os-psource-std-transposed.f03",116)
  call alloc(ppos_cell, (/p_x_dim, ncells_total * ppcell/),"spec/psource/os-psource-std-transposed.f03",117)
  call alloc(pcharge, (/ncells_total * ppcell/),"spec/psource/os-psource-std-transposed.f03",118)
  ...
  call freemem(ppos,"spec/psource/os-psource-std-transposed.f03",382)
  call freemem(ppos_cell,"spec/psource/os-psource-std-transposed.f03",383)
  call freemem(pcharge,"spec/psource/os-psource-std-transposed.f03",384)
  call freemem(pidx,"spec/psource/os-psource-std-transposed.f03",385)
