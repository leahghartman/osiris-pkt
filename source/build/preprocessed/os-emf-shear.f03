# 1 "shear/os-emf-shear.f03"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 467 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "shear/os-emf-shear.f03" 2
...
subroutine read_input_shear( this, input_file, periodic, if_move, grid, dx, dt, gamma )
  ...
  if (ierr == 0) then
    ...
    if (mpi_node()==0) print *," - no shear parameters specified"
    stop
  endif
