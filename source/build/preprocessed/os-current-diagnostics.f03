# 1 "current/os-current-diagnostics.f03"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 467 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "current/os-current-diagnostics.f03" 2
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
# 8 "current/os-current-diagnostics.f03" 2
...
# 9 "current/os-current-diagnostics.f03" 2
...
subroutine init_diag_current( this, interpolation )
  ...
  case default
    interp_offset = 0.0_p_double
    write(err_buf__,*) 'Interpolation value not supported';call err__("current/os-current-diagnostics.f03",138)
