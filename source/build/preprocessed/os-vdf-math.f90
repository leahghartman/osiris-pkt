# 1 "vdf/os-vdf-math.f90"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 467 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "vdf/os-vdf-math.f90" 2
...
subroutine add_vdf( vdf_a, vdf_b )
  ...
  if ( n /= size( vdf_b % buffer )) then
    write(err_buf__,*) 'Incompatible size between vdf_a and vdf_b';call err__("vdf/os-vdf-math.f90",96)
...
subroutine transpose_vdf( self, dir1, dir2, copy, tback )
  ...
  if ( lcopy ) then
    ...
    case(2)
      ...
      call alloc(f2, lb, ub,"vdf/os-vdf-math.f90",821)
    ...
    case(3)
      ! allocate temporary storage
      call alloc(f3, lb, ub,"vdf/os-vdf-math.f90",843)
    ...
    select case (self%x_dim_)
    case(2)
      call freemem(self%f2,"vdf/os-vdf-math.f90",921)
      self%f2 => f2

    case(3)
      call freemem(self%f3,"vdf/os-vdf-math.f90",925)
      self%f3 => f3
    ...
    select case (self%x_dim_)
    case(2)
      call freemem(self%f2,"vdf/os-vdf-math.f90",937)
      call alloc(self%f2, lb, ub,"vdf/os-vdf-math.f90",938)

    case(3)
      call freemem(self%f3,"vdf/os-vdf-math.f90",941)
      call alloc(self%f3, lb, ub,"vdf/os-vdf-math.f90",942)
