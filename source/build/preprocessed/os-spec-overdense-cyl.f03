# 1 "overdense-cyl/os-spec-overdense-cyl.f03"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 467 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "overdense-cyl/os-spec-overdense-cyl.f03" 2
...
# 3 "overdense-cyl/os-spec-overdense-cyl.f03" 2
...
# 4 "overdense-cyl/os-spec-overdense-cyl.f03" 2
...
# 19 "./memory/memory.h"
use memory
# 8 "overdense-cyl/os-spec-overdense-cyl.f03" 2
  ...
  if ( this%splitter%if_recombine ) then
    ...
    do
      ...
      if ( recombine%if_recombine_local ) then
        call freemem(recombine%cells,"overdense-cyl/os-spec-overdense-cyl.f03",411)
      endif
      ...
      if ( recombine%if_recombine_local ) then
        ...
        call alloc(recombine%cells, (/ cell_count /),"overdense-cyl/os-spec-overdense-cyl.f03",425)
...
# 1075 "overdense-cyl/os-spec-overdense-cyl.f03"
    ...
    write(err_buf__,*) "Something went wrong in particle recombinations.";call err__("overdense-cyl/os-spec-overdense-cyl.f03",1133)
    write(err_buf__,*) "Hopefully Josh was still debugging them.";call err__("overdense-cyl/os-spec-overdense-cyl.f03",1134)
    call abort_program( p_err_invalid )
