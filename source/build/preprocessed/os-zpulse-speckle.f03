# 1 "zpulse/os-zpulse-speckle.f03"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 467 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "zpulse/os-zpulse-speckle.f03" 2
...
# 9 "zpulse/os-zpulse-speckle.f03" 2
...
# 10 "zpulse/os-zpulse-speckle.f03" 2
...
# 19 "./memory/memory.h"
use memory
# 14 "zpulse/os-zpulse-speckle.f03" 2
...
subroutine new_gaussian_psd_timeseries( this )
  ...
  call fft % init( nt, .true. )
  call alloc(profile, (/ nt /),"zpulse/os-zpulse-speckle.f03",413)
  ...
  if ( this%speckle_type == p_ssd ) then
    ...
    call fft % ifft( this%buff_1d(1:2,:), nt )
  ...
  case ( 1, 2 )
    ...
    if ( this%speckle_type == p_ssd ) then
      ...
      call fft % ifft( this%buff_2d, (/ nt, this%n_speckle(1) /) )
  ...
  case ( 3 )
    ...
    if ( this%speckle_type == p_ssd ) then
      if ( this%laser_bandwidth(2) > 0 ) then
        ...
        call fft % ifft( this%buff_1d(2:3,:), nt )
      ...
      call fft % ifft( this%buff_3d, (/ nt, this%n_speckle(1), this%n_speckle(2) /) )
  ...
  call freemem(profile,"zpulse/os-zpulse-speckle.f03",544)
  call fft % cleanup()
...
subroutine read_input_zpulse_speckle( this, input_file, g_space, bnd_con, periodic, grid, sim_options )
  ...
  if (mpi_node()==0) print *," - Reading zpulse_speckle configuration..."
    ...
    if ( no_co % on_edge(this%direction, active_wall) ) then
      ...
      case ( 1, 2 )
        if ( this%speckle_type == p_ssd ) then
          ...
          call alloc(this%buff_2d, (/ 2, this%n_speckle(1), 1 /),"zpulse/os-zpulse-speckle.f03",1758)

          select case( this%bandwidth_type )
          case ( p_gaussian_spectrum, p_lorentzian_spectrum )
            call alloc(this%buff_1d, (/ 2, this%nt /),"zpulse/os-zpulse-speckle.f03",1762)
          case ( p_line_spectrum )
            call alloc(this%pmp_2d, (/ this%nfm(1) /),"zpulse/os-zpulse-speckle.f03",1764)
          end select

        else

          call alloc(this%buff_2d, (/ 2, this%n_speckle(1), this%nt /),"zpulse/os-zpulse-speckle.f03",1769)

        endif

        call alloc(this%pp_2d, (/ this % n_speckle(1) /),"zpulse/os-zpulse-speckle.f03",1773)
        call alloc(this%per_wall_2d, (/ 4, this%per_lnx(1) /),"zpulse/os-zpulse-speckle.f03",1774)
        call alloc(this%per_mode_2d, (/ 4, this%n_speckle(1), this%per_lnx(1) /),"zpulse/os-zpulse-speckle.f03",1775)

      case ( 3 )
        if ( this%speckle_type == p_ssd ) then

          call alloc(this%buff_3d, (/ 2, this%n_speckle(1), this%n_speckle(2), 1 /),"zpulse/os-zpulse-speckle.f03",1780)

          select case( this%bandwidth_type )
          case ( p_gaussian_spectrum, p_lorentzian_spectrum )
            call alloc(this%buff_1d, (/ 3, this%nt /),"zpulse/os-zpulse-speckle.f03",1784)
          case ( p_line_spectrum )
            call alloc(this%pmp_3d, (/ max(this%nfm(1), this%nfm(2)), 2 /),"zpulse/os-zpulse-speckle.f03",1786)
          end select

        else

          call alloc(this%buff_3d, (/ 2, this%n_speckle(1), this%n_speckle(2), this%nt /),"zpulse/os-zpulse-speckle.f03",1791)

        endif
        call alloc(this%pp_3d, (/ this % n_speckle(1), this % n_speckle(2) /),"zpulse/os-zpulse-speckle.f03",1794)
        call alloc(this%per_wall_3d, (/ 4, this%per_lnx(1), this%per_lnx(2) /),"zpulse/os-zpulse-speckle.f03",1795)
        call alloc(this%per_mode_3d, (/ 4, this%n_speckle(1)*this%n_speckle(2), this%per_lnx(1), this%per_lnx(2) /),"zpulse/os-zpulse-speckle.f03",1796)
      end select
...
subroutine cleanup_zpulse_speckle( this )
  ...
  if ( associated( this%buff_1d ) ) then
    call freemem(this%buff_1d,"zpulse/os-zpulse-speckle.f03",1956)
  endif
  ! no cleanup required
  select case ( p_x_dim )
  !case ( 1 )
  case ( 1, 2 )
    call freemem(this%buff_2d,"zpulse/os-zpulse-speckle.f03",1962)
    call freemem(this%pp_2d,"zpulse/os-zpulse-speckle.f03",1963)
    call freemem(this%per_wall_2d,"zpulse/os-zpulse-speckle.f03",1964)
    call freemem(this%per_mode_2d,"zpulse/os-zpulse-speckle.f03",1965)
    if ( associated( this%pmp_2d ) ) then
      call freemem(this%pmp_2d,"zpulse/os-zpulse-speckle.f03",1967)
    endif
  case ( 3 )
    call freemem(this%buff_3d,"zpulse/os-zpulse-speckle.f03",1970)
    call freemem(this%pp_3d,"zpulse/os-zpulse-speckle.f03",1971)
    call freemem(this%per_wall_3d,"zpulse/os-zpulse-speckle.f03",1972)
    call freemem(this%per_mode_3d,"zpulse/os-zpulse-speckle.f03",1973)
    if ( associated( this%pmp_3d ) ) then
      call freemem(this%pmp_3d,"zpulse/os-zpulse-speckle.f03",1975)
    endif
  end select
