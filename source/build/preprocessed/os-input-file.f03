...
! Maximum size for the name of the file sections
...
type t_input_file
  ...
  ! Flag for whether to display output when reading/setting up objects
  logical :: display_out = .true.
...
! ---------------------------------------------------------------------------------------
! Init the input file synthetically by directly imposing an input deck (rather then reading for a file)
! ---------------------------------------------------------------------------------------
...
!-------------------------------------------------------------------------------
! Whether or not to display output during read
!-------------------------------------------------------------------------------
...
!-------------------------------------------------------------------------------
! Cancel all subsequent output display
!-------------------------------------------------------------------------------
