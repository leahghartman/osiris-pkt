# 1 "cyl_modes/os-zpulse-cyl-modes.f03"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 467 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "cyl_modes/os-zpulse-cyl-modes.f03" 2
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
# 6 "cyl_modes/os-zpulse-cyl-modes.f03" 2
...
# 7 "cyl_modes/os-zpulse-cyl-modes.f03" 2
...
# 19 "./memory/memory.h"
use memory
# 11 "cyl_modes/os-zpulse-cyl-modes.f03" 2
  ...
  if( this%per_center(1) == 0.5_p_double * ( xmin( g_space, 2 ) + xmax( g_space, 2 ) ) ) then
   ! set per_center to be on axis (otherwise the pulse will be invalid)
    ...
    if( this%per_center(1) .ne. 0 ) then
      ...
      if (mpi_node()==0) print *,"   cylindrically symmetric pulses)"
      stop
    endif
  endif
