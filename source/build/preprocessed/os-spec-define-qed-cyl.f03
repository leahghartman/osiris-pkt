# 1 "qed-cyl/os-spec-define-qed-cyl.f03"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 467 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "qed-cyl/os-spec-define-qed-cyl.f03" 2
!-----------------------------------------------------------------------------------------
...
# 6 "qed-cyl/os-spec-define-qed-cyl.f03" 2
# 1 "./os-config.h" 1
...
# 7 "qed-cyl/os-spec-define-qed-cyl.f03" 2
...
# 19 "./memory/memory.h"
use memory
# 11 "qed-cyl/os-spec-define-qed-cyl.f03" 2
...
subroutine allocate_objs_spec_qedcyl( this )
  ...
  if (this%ndump_fac_radspect > 0) then
      ! allocate arrays
      call alloc(this%radspect, (/ this%radspect_bins /),"qed-cyl/os-spec-define-qed-cyl.f03",245)
      call alloc(this%radspect_oor, (/ 2 /),"qed-cyl/os-spec-define-qed-cyl.f03",246)
  ...
  if (this%ndump_fac_chi_emit > 0) then
      ! allocate arrays
      call alloc(this%chispect_leptons, (/ this%chi_emit_nbins /),"qed-cyl/os-spec-define-qed-cyl.f03",256)
      call alloc(this%chispect_photons, (/ this%chi_emit_nbins /),"qed-cyl/os-spec-define-qed-cyl.f03",257)
  ...
  if (this%ndump_fac_radanglespect > 0) then
      ! allocate arrays
      call alloc(this%radanglespect, (/ this%radanglespect_bins, this%radanglespect_bins, 6 /),"qed-cyl/os-spec-define-qed-cyl.f03",268)
  ...
  if (this%ndump_fac_radsphere > 0) then
      ! allocate arrays
      call alloc(this%radsphere, (/ this%radsphere_nbins, this%radsphere_nbins, 6 /),"qed-cyl/os-spec-define-qed-cyl.f03",277)
  ...
  if (this%ndump_fac_raddetector > 0) then
      ! allocate arrays
      call alloc(this%raddetector, (/ this%raddetector_nbins, this%raddetector_nbins /),"qed-cyl/os-spec-define-qed-cyl.f03",286)
...
subroutine cleanup_spec_qedcyl( this )
  ...
  if (this%ndump_fac_radspect > 0) then
    ! allocate arrays
    call freemem(this%radspect,"qed-cyl/os-spec-define-qed-cyl.f03",391)
    call freemem(this%radspect_oor,"qed-cyl/os-spec-define-qed-cyl.f03",392)
  endif

  ! cleanup chi spectrum diagnostic arrays
  if (this%ndump_fac_chi_emit > 0) then
    ! allocate arrays
    call freemem(this%chispect_leptons,"qed-cyl/os-spec-define-qed-cyl.f03",398)
    call freemem(this%chispect_photons,"qed-cyl/os-spec-define-qed-cyl.f03",399)
  endif

  ! cleanup spherical radiated energy spectrum diagnostic arrays
  if (this%ndump_fac_radanglespect > 0) then
    ! allocate arrays
    call freemem(this%radanglespect,"qed-cyl/os-spec-define-qed-cyl.f03",405)
  endif

  ! cleanup spherical radiated energy spectrum diagnostic arrays
  if (this%ndump_fac_radsphere > 0) then
    ! deallocate arrays
    call freemem(this%radsphere,"qed-cyl/os-spec-define-qed-cyl.f03",411)
  endif

  ! cleanup detector diagnostic array
  if (this%ndump_fac_raddetector > 0) then
    ! deallocate arrays
    call freemem(this%raddetector,"qed-cyl/os-spec-define-qed-cyl.f03",417)
  endif
