# 1 "qed/os-mergedel.f03"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 467 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "qed/os-mergedel.f03" 2
...
subroutine read_input_merge_info( this, input_file )
  ...
  if ( ierr == 0 ) then
    ...
    if (mpi_node()==0) print *,"   - no particle merging specified"
  endif
...
subroutine init_merge( this, num_merge_cells, num_par_max_merge_cell, npc_total )
  ...
  call alloc(this%pmin, (/ p_p_dim, num_merge_cells /),"qed/os-mergedel.f03",180)
  call alloc(this%pmax, (/ p_p_dim, num_merge_cells /),"qed/os-mergedel.f03",181)
  call alloc(this%mcell_i, (/ num_merge_cells /),"qed/os-mergedel.f03",182)
  call alloc(this%mcell_numpar, (/ num_merge_cells /),"qed/os-mergedel.f03",183)

  ! this is the only one that varies from call to call
  call alloc(this%part_pspace, (/ num_par_max_merge_cell /),"qed/os-mergedel.f03",186)

  ! I switched the indexes here to keep all momentum components close in memory
  call alloc(this%ptot, (/ p_p_dim, npc_total /),"qed/os-mergedel.f03",189)
  call alloc(this%pfirst, (/ p_p_dim, npc_total /),"qed/os-mergedel.f03",190)
  call alloc(this%psecond, (/ p_p_dim, npc_total /),"qed/os-mergedel.f03",191)

  call alloc(this%enetot, (/ npc_total /),"qed/os-mergedel.f03",193)
  call alloc(this%weighttot, (/ npc_total /),"qed/os-mergedel.f03",194)
  call alloc(this%numpar_per_pc, (/ npc_total /),"qed/os-mergedel.f03",195)
  call alloc(this%enefirst, (/ npc_total /),"qed/os-mergedel.f03",196)
  call alloc(this%weightfirst, (/ npc_total /),"qed/os-mergedel.f03",197)
  call alloc(this%enesecond, (/ npc_total /),"qed/os-mergedel.f03",198)
  call alloc(this%weightsecond, (/ npc_total /),"qed/os-mergedel.f03",199)
  call alloc(this%ifirst, (/ npc_total /),"qed/os-mergedel.f03",200)
  call alloc(this%isecond, (/ npc_total /),"qed/os-mergedel.f03",201)
...
subroutine cleanup_merge( this )
  ...
  call freemem(this%pmin,"qed/os-mergedel.f03",210)
  call freemem(this%pmax,"qed/os-mergedel.f03",211)
  call freemem(this%mcell_i,"qed/os-mergedel.f03",212)
  call freemem(this%mcell_numpar,"qed/os-mergedel.f03",213)
  call freemem(this%part_pspace,"qed/os-mergedel.f03",214)
  call freemem(this%ptot,"qed/os-mergedel.f03",215)
  call freemem(this%enetot,"qed/os-mergedel.f03",216)
  call freemem(this%weighttot,"qed/os-mergedel.f03",217)
  call freemem(this%numpar_per_pc,"qed/os-mergedel.f03",218)
  call freemem(this%pfirst,"qed/os-mergedel.f03",219)
  call freemem(this%enefirst,"qed/os-mergedel.f03",220)
  call freemem(this%weightfirst,"qed/os-mergedel.f03",221)
  call freemem(this%psecond,"qed/os-mergedel.f03",222)
  call freemem(this%enesecond,"qed/os-mergedel.f03",223)
  call freemem(this%weightsecond,"qed/os-mergedel.f03",224)
  call freemem(this%ifirst,"qed/os-mergedel.f03",225)
  call freemem(this%isecond,"qed/os-mergedel.f03",226)
  ...
  if ( merge_info%n_check_max_sim_particles > 0 ) then
    if ( ( n > 0 ) .and. ( mod( n, merge_info%n_check_max_sim_particles ) == 0 ) ) then
      ...
      if ( (species%num_par > merge_info%max_sim_particles) .and. (species % num_par > 2) ) then
        ...
        call alloc(sap_merge_aid, (/num_merge_cells/),"qed/os-mergedel.f03",292)
        ...
        call merge % cleanup()
        call freemem(sap_merge_aid,"qed/os-mergedel.f03",334)
...
subroutine momentum_space(merge, species, num_merge_cells, npc_total, max_weight, part_type )
  ...
  if ( delidx%buf_size < species%num_par ) then
    call freemem(delidx%idx,"qed/os-mergedel.f03",394)
    call alloc(delidx%idx, (/ species%num_par + 16384 /),"qed/os-mergedel.f03",395)
...
!---------------------------------------------------------------------------------------------------
  ...
  if ( (t > species%push_start_time)) then
    ...
    call alloc(idx, (/species%num_par/),"qed/os-mergedel.f03",611)
    ...
    call freemem(idx,"qed/os-mergedel.f03",632)
...
subroutine generate_sort_merge_idx_1d( species, ip, nx_collision_cells, coll_aid )
  ...
  !---------------------------------------------------------------------------------------------------
    ...
    call alloc(npic, (/ n_grid /),"qed/os-mergedel.f03",684)
    ...
    ! call asrt__(isum == species%num_par,"isum == species%num_par","qed/os-mergedel.f03",707)
    ...
    call freemem(npic,"qed/os-mergedel.f03",720)
...
!---------------------------------------------------------------------------------------------------
  ...
  call alloc(npic, (/ n_grid /),"qed/os-mergedel.f03",767)
  ...
  ! isum must be the same as the total number of particles
  ! call asrt__(isum == species%num_par,"isum == species%num_par","qed/os-mergedel.f03",795)
  ...
  call freemem(npic,"qed/os-mergedel.f03",808)
...
!---------------------------------------------------------------------------------------------------
  ...
  call alloc(npic, (/ n_grid /),"qed/os-mergedel.f03",860)
  ...
  call freemem(npic,"qed/os-mergedel.f03",904)
