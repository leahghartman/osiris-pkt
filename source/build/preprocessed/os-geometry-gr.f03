# 1 "gr/os-geometry-gr.f03"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 467 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gr/os-geometry-gr.f03" 2
# 1 "./os-config.h" 1
...
subroutine spline_t_gr( this, jx, y, s )
  ...
  ! get weight functions
  aux_0 = (- ys * this%st%f1(2, jx) - 0.5_p_double * dt * ys * ys * this%ct%f1(2, jx)) / (this%st%f1(2, jx) + dt * y * this%ct%f1(2, jx))
...
!-----------------------------------------------------------------------------------------
  ...
  call restart_io_write("p_geometry_gr_rst_id", p_geometry_gr_rst_id, restart_handle, ierr)
  call check_error(ierr,err_msg,p_err_rstwrt,"gr/os-geometry-gr.f03",1089)
...
!-----------------------------------------------------------------------------------------
  ...
  call check_error(ierr,err_msg,p_err_rstrd,"gr/os-geometry-gr.f03",1115)
