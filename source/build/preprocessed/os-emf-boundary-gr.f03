# 1 "gr/os-emf-boundary-gr.f03"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 467 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gr/os-emf-boundary-gr.f03" 2
# 1 "./os-config.h" 1
...
!-----------------------------------------------------------------------------------------
  ...
  call restart_io_write("p_bcemf_gr_rst_id", p_bcemf_gr_rst_id, restart_handle, ierr)
  call check_error(ierr,err_msg,p_err_rstwrt,"gr/os-emf-boundary-gr.f03",444)
...
!-----------------------------------------------------------------------------------------
  ...
  call check_error(ierr,err_msg,p_err_rstrd,"gr/os-emf-boundary-gr.f03",478)
