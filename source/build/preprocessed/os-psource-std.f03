# 1 "spec/psource/os-psource-std.f03"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 467 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "spec/psource/os-psource-std.f03" 2
# 1 "./os-config.h" 1
...
# 2 "spec/psource/os-psource-std.f03" 2
...
# 3 "spec/psource/os-psource-std.f03" 2
...
# 19 "./memory/memory.h"
use memory
# 7 "spec/psource/os-psource-std.f03" 2
...
! Must use interface statement to avoid type casting the python source with call
interface
...
subroutine read_input_std( this, input_file, coordinates )
  ...
  if ((this%if_mult) .and. ( num_x > 0 )) then
    call alloc(this%x, (/ num_x, p_x_dim /),"spec/psource/os-psource-std.f03",408)
    call alloc(this%fx, (/ num_x, p_x_dim /),"spec/psource/os-psource-std.f03",409)
  endif
...
subroutine cleanup_std( this )
  ...
  call freemem(this%x,"spec/psource/os-psource-std.f03",531)
  call freemem(this%fx,"spec/psource/os-psource-std.f03",532)
...
# 19 "./memory/memory.h"
use memory
# 786 "spec/psource/os-psource-std.f03" 2
  ...
  call alloc(ppos, (/p_x_dim, ppcell/),"spec/psource/os-psource-std.f03",863)
  call alloc(ppos_cell, (/p_x_dim, ppcell/),"spec/psource/os-psource-std.f03",864)
  call alloc(pcharge, (/ppcell/),"spec/psource/os-psource-std.f03",865)
  ...
  call freemem(ppos,"spec/psource/os-psource-std.f03",1140)
  call freemem(ppos_cell,"spec/psource/os-psource-std.f03",1141)
  call freemem(pcharge,"spec/psource/os-psource-std.f03",1142)
