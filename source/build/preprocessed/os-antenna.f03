...
integer, parameter, public :: p_env_supergaussian = 4 ! supergaussian profile.
integer, parameter, public :: p_alfven_offset = 8 ! grid offset for Alfven antenna


! *************************************************************************
! for alfven waves
integer, parameter, public :: p_alfven_cell = 9 ! alfven wave launcher index
! for alfven waves
! *************************************************************************
...
!-----------------------------------------------------------------------------------------
  ...
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error reading restart data for antenna object.';call err__("os-antenna.f03",351)
    call abort_program(p_err_rstrd)
  endif

  ! check if restart file is compatible
  if ( rst_id /= p_ant_rst_id) then
    write(err_buf__,*) 'Corrupted restart file, or restart file from';call err__("os-antenna.f03",357)
    write(err_buf__,*) 'incompatible binary (antenna)';call err__("os-antenna.f03",358)
    call abort_program(p_err_rstrd)
  endif

  call restart_io_read(this%a0, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error reading restart data for antenna object.';call err__("os-antenna.f03",364)
    call abort_program(p_err_rstrd)
  endif
  call restart_io_read(this%t_rise, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error reading restart data for antenna object.';call err__("os-antenna.f03",369)
    call abort_program(p_err_rstrd)
  endif
  call restart_io_read(this%t_flat, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error reading restart data for antenna object.';call err__("os-antenna.f03",374)
    call abort_program(p_err_rstrd)
  endif
  call restart_io_read(this%t_fall, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error reading restart data for antenna object.';call err__("os-antenna.f03",379)
    call abort_program(p_err_rstrd)
  endif
  call restart_io_read(this%t_offset, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error reading restart data for antenna object.';call err__("os-antenna.f03",384)
    call abort_program(p_err_rstrd)
  endif
  call restart_io_read(this%omega0, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error reading restart data for antenna object.';call err__("os-antenna.f03",389)
    call abort_program(p_err_rstrd)
  endif
  call restart_io_read(this%x0, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error reading restart data for antenna object.';call err__("os-antenna.f03",394)
    call abort_program(p_err_rstrd)
  endif
  call restart_io_read(this%y0, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error reading restart data for antenna object.';call err__("os-antenna.f03",399)
    call abort_program(p_err_rstrd)
  endif
  call restart_io_read(this%rad_x, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error reading restart data for antenna object.';call err__("os-antenna.f03",404)
    call abort_program(p_err_rstrd)
  endif
  call restart_io_read(this%rad_y, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error reading restart data for antenna object.';call err__("os-antenna.f03",409)
    call abort_program(p_err_rstrd)
  endif
  call restart_io_read(this%spin, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error reading restart data for antenna object.';call err__("os-antenna.f03",414)
    call abort_program(p_err_rstrd)
  endif
  call restart_io_read(this%pol, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error reading restart data for antenna object.';call err__("os-antenna.f03",419)
    call abort_program(p_err_rstrd)
  endif
  call restart_io_read(this%ant_type, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error reading restart data for antenna object.';call err__("os-antenna.f03",424)
    call abort_program(p_err_rstrd)
  endif
  call restart_io_read(this%side, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error reading restart data for antenna object.';call err__("os-antenna.f03",429)
    call abort_program(p_err_rstrd)
  endif
  call restart_io_read(this%direction, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error reading restart data for antenna object.';call err__("os-antenna.f03",434)
    call abort_program(p_err_rstrd)
  endif
  call restart_io_read(this%delay, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error reading restart data for antenna object.';call err__("os-antenna.f03",439)
    call abort_program(p_err_rstrd)
  endif
  call restart_io_read(this%tilt, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error reading restart data for antenna object.';call err__("os-antenna.f03",444)
    call abort_program(p_err_rstrd)
  endif
  call restart_io_read(this%phase, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error reading restart data for antenna object.';call err__("os-antenna.f03",449)
    call abort_program(p_err_rstrd)
  endif
  call restart_io_read(this%phase2, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error reading restart data for antenna object.';call err__("os-antenna.f03",454)
    call abort_program(p_err_rstrd)
  endif
  call restart_io_read(this%z_r, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error reading restart data for antenna object.';call err__("os-antenna.f03",459)
    call abort_program(p_err_rstrd)
  endif
  call restart_io_read(this%curv_const, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error reading restart data for antenna object.';call err__("os-antenna.f03",464)
    call abort_program(p_err_rstrd)
  endif
  call restart_io_read(this%focus, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error reading restart data for antenna object.';call err__("os-antenna.f03",469)
    call abort_program(p_err_rstrd)
  endif
...
!-----------------------------------------------------------------------------------------
  ...
  call restart_io_write("p_ant_rst_id", p_ant_rst_id, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error writing restart data for antenna object.';call err__("os-antenna.f03",491)
    call abort_program(p_err_rstwrt)
  endif

  call restart_io_write("this%a0", this%a0, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error writing restart data for antenna object.';call err__("os-antenna.f03",497)
    call abort_program(p_err_rstwrt)
  endif
  call restart_io_write("this%t_rise", this%t_rise, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error writing restart data for antenna object.';call err__("os-antenna.f03",502)
    call abort_program(p_err_rstwrt)
  endif
  call restart_io_write("this%t_flat", this%t_flat, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error writing restart data for antenna object.';call err__("os-antenna.f03",507)
    call abort_program(p_err_rstwrt)
  endif
  call restart_io_write("this%t_fall", this%t_fall, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error writing restart data for antenna object.';call err__("os-antenna.f03",512)
    call abort_program(p_err_rstwrt)
  endif
  call restart_io_write("this%t_offset", this%t_offset, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error writing restart data for antenna object.';call err__("os-antenna.f03",517)
    call abort_program(p_err_rstwrt)
  endif
  call restart_io_write("this%omega0", this%omega0, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error writing restart data for antenna object.';call err__("os-antenna.f03",522)
    call abort_program(p_err_rstwrt)
  endif
  call restart_io_write("this%x0", this%x0, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error writing restart data for antenna object.';call err__("os-antenna.f03",527)
    call abort_program(p_err_rstwrt)
  endif
  call restart_io_write("this%y0", this%y0, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error writing restart data for antenna object.';call err__("os-antenna.f03",532)
    call abort_program(p_err_rstwrt)
  endif
  call restart_io_write("this%rad_x", this%rad_x, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error writing restart data for antenna object.';call err__("os-antenna.f03",537)
    call abort_program(p_err_rstwrt)
  endif
  call restart_io_write("this%rad_y", this%rad_y, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error writing restart data for antenna object.';call err__("os-antenna.f03",542)
    call abort_program(p_err_rstwrt)
  endif
  call restart_io_write("this%spin", this%spin, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error writing restart data for antenna object.';call err__("os-antenna.f03",547)
    call abort_program(p_err_rstwrt)
  endif
  call restart_io_write("this%pol", this%pol, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error writing restart data for antenna object.';call err__("os-antenna.f03",552)
    call abort_program(p_err_rstwrt)
  endif
  call restart_io_write("this%ant_type", this%ant_type, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error writing restart data for antenna object.';call err__("os-antenna.f03",557)
    call abort_program(p_err_rstwrt)
  endif
  call restart_io_write("this%side", this%side, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error writing restart data for antenna object.';call err__("os-antenna.f03",562)
    call abort_program(p_err_rstwrt)
  endif
  call restart_io_write("this%direction", this%direction, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error writing restart data for antenna object.';call err__("os-antenna.f03",567)
    call abort_program(p_err_rstwrt)
  endif
  call restart_io_write("this%delay", this%delay, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error writing restart data for antenna object.';call err__("os-antenna.f03",572)
    call abort_program(p_err_rstwrt)
  endif
  call restart_io_write("this%tilt", this%tilt, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error writing restart data for antenna object.';call err__("os-antenna.f03",577)
    call abort_program(p_err_rstwrt)
  endif
  call restart_io_write("this%phase", this%phase, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error writing restart data for antenna object.';call err__("os-antenna.f03",582)
    call abort_program(p_err_rstwrt)
  endif
  call restart_io_write("this%phase2", this%phase2, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error writing restart data for antenna object.';call err__("os-antenna.f03",587)
    call abort_program(p_err_rstwrt)
  endif
  call restart_io_write("this%z_r", this%z_r, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error writing restart data for antenna object.';call err__("os-antenna.f03",592)
    call abort_program(p_err_rstwrt)
  endif
  call restart_io_write("this%curv_const", this%curv_const, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error writing restart data for antenna object.';call err__("os-antenna.f03",597)
    call abort_program(p_err_rstwrt)
  endif
  call restart_io_write("this%focus", this%focus, restart_handle, ierr)
  if ( ierr/=0 ) then
    write(err_buf__,*) 'error writing restart data for antenna object.';call err__("os-antenna.f03",602)
    call abort_program(p_err_rstwrt)
  endif
