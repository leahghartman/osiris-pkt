# 1 "emf/solver/os-emf-solver.f03"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 467 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "emf/solver/os-emf-solver.f03" 2
module m_emf_solver
...
subroutine new_solver_emf( this, name )
    ...
    case( "4order" )
        allocate( t_emf_solver_4order :: this%solver )
    case( "ck" )
        allocate( t_emf_solver_ck :: this%solver )
    case( "lehe" )
...
function solver_type_class_emf( this )
    ...
    class is ( t_emf_solver_4order )
        solver_type_class_emf = p_emf_4order
    class is ( t_emf_solver_ck )
        solver_type_class_emf = p_emf_ck
...
function solver_type_name_emf( this, name )
    ...
    case( "4order" )
        solver_type_name_emf = p_emf_4order
    case( "ck" )
        solver_type_name_emf = p_emf_ck
    case( "lehe" )
