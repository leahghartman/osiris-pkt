# 1 "cyl_modes/os-zpulse-flyfoc-cyl-modes.f03"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 467 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "cyl_modes/os-zpulse-flyfoc-cyl-modes.f03" 2
# 1 "./os-config.h" 1
...
# 2 "cyl_modes/os-zpulse-flyfoc-cyl-modes.f03" 2
...
# 3 "cyl_modes/os-zpulse-flyfoc-cyl-modes.f03" 2
...
# 19 "./memory/memory.h"
use memory
# 7 "cyl_modes/os-zpulse-flyfoc-cyl-modes.f03" 2
...
! get type of envelope to use
  ...
  if( this%env_type .eq. p_gaussian_new .or. this%env_type .eq. p_laguerre_new ) then
    ...
    call alloc(this%astrl_discrete_focal_points, (/ N /),"cyl_modes/os-zpulse-flyfoc-cyl-modes.f03",715)
    call alloc(this%astrl_discrete_focal_delays, (/ N /),"cyl_modes/os-zpulse-flyfoc-cyl-modes.f03",716)
    call alloc(this%astrl_discrete_focal_weights, (/ N /),"cyl_modes/os-zpulse-flyfoc-cyl-modes.f03",717)
    call alloc(this%astrl_discrete_focal_phases, (/ N /),"cyl_modes/os-zpulse-flyfoc-cyl-modes.f03",718)
...
subroutine init_extra_vars_zpulse_flyfoc_cyl_modes( this )
  ...
  case( p_astrl, p_astrl_laguerre, p_astrl_chromatic )
    ...
    call alloc(this%buf_1d, (/ this%integral_size /),"cyl_modes/os-zpulse-flyfoc-cyl-modes.f03",938)
    this%buf_1d(:) = 0
...
subroutine init_env_norm_zpulse_flyfoc_cyl_modes( this, grid, g_space )
  ...
  case( p_astrl, p_astrl_laguerre, p_astrl_chromatic )
    ...
    case default
      ...
      if (mpi_node()==0) print *,"ERROR: Should not reach here in init_env_norm_zpulse_flyfoc_cyl_modes"
      stop
      delay = 0
    ...
    call alloc(norm_buf, (/nx2/),"cyl_modes/os-zpulse-flyfoc-cyl-modes.f03",1018)
    ...
    call freemem(norm_buf,"cyl_modes/os-zpulse-flyfoc-cyl-modes.f03",1035)
...
subroutine cleanup_zpulse_flyfoc_cyl_modes( this )
  ...
  if ( associated(this%e_env_buffer) ) call freemem(this%e_env_buffer,"cyl_modes/os-zpulse-flyfoc-cyl-modes.f03",1155)

  if ( associated(this%buf_1d)) call freemem(this%buf_1d,"cyl_modes/os-zpulse-flyfoc-cyl-modes.f03",1157)

  if( associated( this%astrl_discrete_focal_delays )) &
      call freemem(this%astrl_discrete_focal_delays,"cyl_modes/os-zpulse-flyfoc-cyl-modes.f03",1160)
  if( associated( this%astrl_discrete_focal_points )) &
      call freemem(this%astrl_discrete_focal_points,"cyl_modes/os-zpulse-flyfoc-cyl-modes.f03",1162)
  if( associated( this%astrl_discrete_focal_weights )) &
      call freemem(this%astrl_discrete_focal_weights,"cyl_modes/os-zpulse-flyfoc-cyl-modes.f03",1164)
  if( associated( this%astrl_discrete_focal_phases )) &
      call freemem(this%astrl_discrete_focal_phases,"cyl_modes/os-zpulse-flyfoc-cyl-modes.f03",1166)
...
subroutine precompute_envelope_zpulse_flyfoc_cyl_modes( this, e, g_space, nx_p_min, dt )
  ...
  call alloc(this%e_env_buffer, (/ nt, nz, nx2 /),"cyl_modes/os-zpulse-flyfoc-cyl-modes.f03",1325)
  this%e_env_buffer(:,:,:) = 0
...
subroutine set_fields_t0_zpulse_flyfoc_cyl_modes( this, e_cyl_m, b_cyl_m, g_space, &
  ...
  if (mpi_node()==0) print *,'Injecting flying focus fields...'
