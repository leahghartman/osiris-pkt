# 1 "radio/os-radio-detector.f03"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 467 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "radio/os-radio-detector.f03" 2
!----------------------------------------------------------------------------------------!
!--------------------------------- DETECTOR BASE CLASS ----------------------------------!
! !
...
# 19 "./memory/memory.h"
use memory
# 17 "radio/os-radio-detector.f03" 2
use m_system
use m_parameters
...
subroutine report_det(this,t,tstep,no_co)
  ...
  if ( test_if_report(tstep,this%ndump_fac) ) then
    ...
    call alloc(write_buffer, (/ this%nf(dp1), this%nf(dp2), this%nf(1)+1 /),"radio/os-radio-detector.f03",215)
    ...
    call freemem(write_buffer,"radio/os-radio-detector.f03",260)
