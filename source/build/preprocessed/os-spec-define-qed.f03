# 1 "qed/os-spec-define-qed.f03"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 467 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "qed/os-spec-define-qed.f03" 2
!-----------------------------------------------------------------------------------------
...
# 6 "qed/os-spec-define-qed.f03" 2
# 1 "./os-config.h" 1
...
# 7 "qed/os-spec-define-qed.f03" 2
...
# 19 "./memory/memory.h"
use memory
# 11 "qed/os-spec-define-qed.f03" 2
...
subroutine allocate_objs_spec_qed( this )
  ...
  if (this%ndump_fac_radspect > 0) then
      ! allocate arrays
      call alloc(this%radspect, (/ this%radspect_bins /),"qed/os-spec-define-qed.f03",261)
      call alloc(this%radspect_oor, (/ 2 /),"qed/os-spec-define-qed.f03",262)
  ...
  if (this%ndump_fac_chi_emit > 0) then
      ! allocate arrays
      call alloc(this%chispect_leptons, (/ this%chi_emit_nbins /),"qed/os-spec-define-qed.f03",272)
      call alloc(this%chispect_photons, (/ this%chi_emit_nbins /),"qed/os-spec-define-qed.f03",273)
  ...
  if (this%ndump_fac_radanglespect > 0) then
      ! allocate arrays
      call alloc(this%radanglespect, (/ this%radanglespect_bins, this%radanglespect_bins, 6 /),"qed/os-spec-define-qed.f03",284)
  ...
  if (this%ndump_fac_radsphere > 0) then
      ! allocate arrays
      call alloc(this%radsphere, (/ this%radsphere_nbins, this%radsphere_nbins, 6 /),"qed/os-spec-define-qed.f03",293)
  ...
  if (this%ndump_fac_raddetector > 0) then
      ! allocate arrays
      call alloc(this%raddetector, (/ this%raddetector_nbins, this%raddetector_nbins /),"qed/os-spec-define-qed.f03",302)
...
subroutine cleanup_spec_qed( this )
  ...
  if (this%ndump_fac_radspect > 0) then
    ! allocate arrays
    call freemem(this%radspect,"qed/os-spec-define-qed.f03",394)
    call freemem(this%radspect_oor,"qed/os-spec-define-qed.f03",395)
  endif

  ! cleanup chi spectrum diagnostic arrays
  if (this%ndump_fac_chi_emit > 0) then
    ! allocate arrays
    call freemem(this%chispect_leptons,"qed/os-spec-define-qed.f03",401)
    call freemem(this%chispect_photons,"qed/os-spec-define-qed.f03",402)
  endif

  ! cleanup spherical radiated energy spectrum diagnostic arrays
  if (this%ndump_fac_radanglespect > 0) then
    ! allocate arrays
    call freemem(this%radanglespect,"qed/os-spec-define-qed.f03",408)
  endif

  ! cleanup spherical radiated energy spectrum diagnostic arrays
  if (this%ndump_fac_radsphere > 0) then
    ! deallocate arrays
    call freemem(this%radsphere,"qed/os-spec-define-qed.f03",414)
  endif

  ! cleanup detector diagnostic array
  if (this%ndump_fac_raddetector > 0) then
    ! deallocate arrays
    call freemem(this%raddetector,"qed/os-spec-define-qed.f03",420)
  endif
