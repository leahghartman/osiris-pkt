# 1 "qed/os-trident-coul.f03"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 467 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "qed/os-trident-coul.f03" 2
...
contains
  ...
  if ( ierr == 0 ) then
      ...
      if (mpi_node()==0) print *,"   - no particle trident_coul specified"
  endif
