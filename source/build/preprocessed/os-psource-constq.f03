# 1 "spec/psource/os-psource-constq.f03"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 467 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "spec/psource/os-psource-constq.f03" 2
# 1 "./os-config.h" 1
...
# 2 "spec/psource/os-psource-constq.f03" 2
...
# 3 "spec/psource/os-psource-constq.f03" 2
...
# 19 "./memory/memory.h"
use memory
# 7 "spec/psource/os-psource-constq.f03" 2
...
function inject_constq( this, species, ig_xbnd_inj, jay, no_co, bnd_cross, node_cross, send_msg, &
  ...
  if ( species%coordinates == p_cylindrical_b ) then
    write(err_buf__,*) 'Cylindrical coordinates are not yet supported with fixed charge injection, aborting.';call err__("spec/psource/os-psource-constq.f03",95)
  ...
  call alloc(ppos, (/p_x_dim, gnp/),"spec/psource/os-psource-constq.f03",135)
  call alloc(ppos_cell, (/p_x_dim, srn /),"spec/psource/os-psource-constq.f03",136)
  call alloc(pcharge, (/ gnp /),"spec/psource/os-psource-constq.f03",137)
  ...
  call freemem(ppos,"spec/psource/os-psource-constq.f03",285)
  call freemem(ppos_cell,"spec/psource/os-psource-constq.f03",286)
  call freemem(pcharge,"spec/psource/os-psource-constq.f03",287)
