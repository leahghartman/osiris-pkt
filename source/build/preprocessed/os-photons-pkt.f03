# 1 "pkt/os-photons-pkt.f03"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 467 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "pkt/os-photons-pkt.f03" 2
# 1 "./os-config.h" 1
...
subroutine advance_photons_pkt(this, den_ph, grad_ph, den_grid, grad_grid, gdt, tid, n_threads)
   ...
   case default
      ...
      case default
         write(err_buf__,*) 'Not implemented for x_dim = ', p_x_dim;call err__("pkt/os-photons-pkt.f03",547)
