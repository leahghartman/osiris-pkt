# 1 "spec/psource/os-psource-file.f03"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 467 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "spec/psource/os-psource-file.f03" 2
# 1 "./os-config.h" 1
...
# 2 "spec/psource/os-psource-file.f03" 2
...
# 3 "spec/psource/os-psource-file.f03" 2
...
# 19 "./memory/memory.h"
use memory
# 7 "spec/psource/os-psource-file.f03" 2
...
function inject_file( this, species, ig_xbnd_inj, jay, no_co, bnd_cross, node_cross, &
  ...
  if(this%raw_read_done) then
    ...
    if(mpi_node() == 0) then
      ...
      select case (p_x_dim)
      case (1)
        call freemem(this%node_map_1d,"spec/psource/os-psource-file.f03",205)
        call alloc(this%node_map_1d, g_nx,"spec/psource/os-psource-file.f03",206)
        this%node_map_1d(:) = 0
      case (2)
        call freemem(this%node_map_2d,"spec/psource/os-psource-file.f03",209)
        call alloc(this%node_map_2d, g_nx,"spec/psource/os-psource-file.f03",210)
        this%node_map_2d(:,:) = 0
      case (3)
        call freemem(this%node_map_3d,"spec/psource/os-psource-file.f03",213)
        call alloc(this%node_map_3d, g_nx,"spec/psource/os-psource-file.f03",214)
        this%node_map_3d(:,:,:) = 0
      case default
    ...
    if( mpi_node() == 0 ) then
      ...
      select case (p_x_dim)
      case (1)
        call freemem(this%node_map_1d,"spec/psource/os-psource-file.f03",333)
      case (2)
        call freemem(this%node_map_2d,"spec/psource/os-psource-file.f03",335)
      case (3)
        call freemem(this%node_map_3d,"spec/psource/os-psource-file.f03",337)
      case default
        write(0,*) 'Error initializing node map'
        call abort_program()
      end select
...
# 588 "spec/psource/os-psource-file.f03"
!-----------------------------------------------------------------------------------------
! send particles
!-----------------------------------------------------------------------------------------
function send_particle_chunk( this, node_data, chunk_data, no_co, g_xbnd, g_nx, dx, npar,&
  ...
  call freemem(part_per_node,"spec/psource/os-psource-file.f03",621)
  call alloc(part_per_node, (/ no_num(no_co) /),"spec/psource/os-psource-file.f03",622)
  part_per_node(:) = 0
  ...
  call freemem(node_counters,"spec/psource/os-psource-file.f03",659)
  call alloc(node_counters, (/ no_num(no_co) /),"spec/psource/os-psource-file.f03",660)
  node_counters = 0

  call freemem(node_starts,"spec/psource/os-psource-file.f03",663)
  call alloc(node_starts, (/ no_num(no_co) /),"spec/psource/os-psource-file.f03",664)
  node_starts = 0

  call freemem(particle_tags,"spec/psource/os-psource-file.f03",667)
  call alloc(particle_tags, (/ j /),"spec/psource/os-psource-file.f03",668)
  particle_tags = 0
  ...
  call freemem(part_per_node,"spec/psource/os-psource-file.f03",750)
  call freemem(node_counters,"spec/psource/os-psource-file.f03",751)
  call freemem(node_starts,"spec/psource/os-psource-file.f03",752)
  call freemem(particle_tags,"spec/psource/os-psource-file.f03",753)
