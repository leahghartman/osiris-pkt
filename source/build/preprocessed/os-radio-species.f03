# 1 "radio/os-radio-species.f03"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 467 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "radio/os-radio-species.f03" 2
...
# 2 "radio/os-radio-species.f03" 2
# 1 "./os-config.h" 1
...
# 3 "radio/os-radio-species.f03" 2
...
# 19 "./memory/memory.h"
use memory
# 7 "radio/os-radio-species.f03" 2
!-----------------------------------------------------------------------------------------
...
subroutine init_species_radiat( this, sp_id, interpolation, grid_center, grid, g_space, &
  ...
  call alloc(this%x_prev, (/n_x_dim,max(this%num_par_max,1) /),"radio/os-radio-species.f03",241)
  call alloc(this%ix_prev, (/p_x_dim,max(this%num_par_max,1) /),"radio/os-radio-species.f03",242)
  call alloc(this%p_prev, (/p_p_dim,max(this%num_par_max,1) /),"radio/os-radio-species.f03",243)
  ...
  if (this%rad_math_expr /= '') then
    ...
    if (ierr /= 0) then
      write(err_buf__,*) "Error compiling supplied function :";call err__("radio/os-radio-species.f03",263)
      write(err_buf__,*) trim(this%rad_math_expr);call err__("radio/os-radio-species.f03",264)
...
subroutine push_species_radiat( this, emf, current, t, tstep, tid, n_threads, options )
  ...
  if ( t >= this%push_start_time ) then
    ...
    case ( p_cylindrical_b )
      write(err_buf__,*) 'Not implemented for cylindrical coordinates';call err__("radio/os-radio-species.f03",307)
...
subroutine cleanup_species_radiat( this )
  ...
  call freemem(this%x_prev,"radio/os-radio-species.f03",329)
  call freemem(this%ix_prev,"radio/os-radio-species.f03",330)
  call freemem(this%p_prev,"radio/os-radio-species.f03",331)
...
subroutine init_buffer_spec_radiat( this, num_par_req )
  ...
  n_x_dim = this%get_n_x_dims()
  call freemem(this%x_prev,"radio/os-radio-species.f03",730)
  call alloc(this%x_prev, (/ n_x_dim, this%num_par_max /),"radio/os-radio-species.f03",731)

  ! initialize particle cell information
  call freemem(this%ix_prev,"radio/os-radio-species.f03",734)
  call alloc(this%ix_prev, (/ p_x_dim, this%num_par_max /),"radio/os-radio-species.f03",735)

  ! setup momenta buffer
  call freemem(this%p_prev,"radio/os-radio-species.f03",738)
  call alloc(this%p_prev, (/ p_p_dim, this%num_par_max /),"radio/os-radio-species.f03",739)
...
subroutine grow_buffer_spec_radiat( this, num_par_req )
  ...
  if ( this%num_par > 0 ) then
    ...
    if ( num_par_new <= num_par_old ) then
      write(err_buf__,*) 'Invalid size for new buffer';call err__("radio/os-radio-species.f03",775)
      call abort_program( p_err_invalid )
    endif
    ...
    n_x_dim = this%get_n_x_dims()
    ! setup position buffer
    call freemem(this%x_prev,"radio/os-radio-species.f03",782)
    call alloc(this%x_prev, (/ n_x_dim, num_par_new /),"radio/os-radio-species.f03",783)

    ! initialize particle cell information
    call freemem(this%ix_prev,"radio/os-radio-species.f03",786)
    call alloc(this%ix_prev, (/ p_x_dim, num_par_new /),"radio/os-radio-species.f03",787)

    ! setup momenta buffer
    call freemem(this%p_prev,"radio/os-radio-species.f03",790)
    call alloc(this%p_prev, (/ p_p_dim, num_par_new /),"radio/os-radio-species.f03",791)
