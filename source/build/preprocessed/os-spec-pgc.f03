# 1 "pgc/os-spec-pgc.f03"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 467 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "pgc/os-spec-pgc.f03" 2
...
subroutine advance_deposit_emf_pgc( this, emf_pgc, jay, t, tstep, tid, n_threads )
  ...
  select case ( this%coordinates )
    ...
    case default
      ...
      case default
        write(err_buf__,*) 'Not implemented for x_dim = ',p_x_dim;call err__("pgc/os-spec-pgc.f03",882)
