# 1 "tiles/topology/os-hilbert.f03"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 467 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "tiles/topology/os-hilbert.f03" 2
! #include "os-config.h"
...
# 3 "tiles/topology/os-hilbert.f03" 2
...
subroutine fill_hi2_hilbert( hi2, n, t )
  ...
  if ( IAND( minval(n), minval(n)-1 )/=0 ) then
    write(err_buf__,*) 'Number of tiles in smallest dimension must be a power of 2';call err__("tiles/topology/os-hilbert.f03",148)
    call abort_program()
  elseif ( minval(n)==1 .and. any(n /= 1) ) then
    write(err_buf__,*) 'If number of tiles in smallest dimension is 1,';call err__("tiles/topology/os-hilbert.f03",151)
    write(err_buf__,*) 'all number of tiles must be 1. Try topology="snake"';call err__("tiles/topology/os-hilbert.f03",152)
    call abort_program()
  endif
  ...
  elseif ( (minval(n)==n(2)) .and. (mod(n(1),n(2))==0) ) then
    ...
    write(err_buf__,*) 'Number of tiles in largest dimension must be multiple of number';call err__("tiles/topology/os-hilbert.f03",183)
    write(err_buf__,*) 'of tiles in smallest dimension';call err__("tiles/topology/os-hilbert.f03",184)
    call abort_program()
  endif
...
recursive subroutine SH( hi3, t, lb, ub, n )
  ...
  select case (minloc(n,1))
    ...
    case default
      write(err_buf__,*) 'Error drawing hilbert curve';call err__("tiles/topology/os-hilbert.f03",786)
      call abort_program()
  end select
...
recursive subroutine SH_( hi3, t, lb, ub, n )
  ...
  select case (minloc(n,1))
    ...
    case default
      write(err_buf__,*) 'Error drawing hilbert curve';call err__("tiles/topology/os-hilbert.f03",893)
      call abort_program()
  end select
...
subroutine fill_hi3_hilbert( hi3, n )
  ...
  if ( IAND( minval(n), minval(n)-1 )/=0 ) then
    write(err_buf__,*) 'Number of tiles in smallest dimension must be a power of 2';call err__("tiles/topology/os-hilbert.f03",918)
    call abort_program()
  elseif ( minval(n)==1 .and. any(n /= 1) ) then
    write(err_buf__,*) 'If number of tiles in smallest dimension is 1,';call err__("tiles/topology/os-hilbert.f03",921)
    write(err_buf__,*) 'all number of tiles must be 1. Try topology="snake"';call err__("tiles/topology/os-hilbert.f03",922)
    call abort_program()
  endif
  ...
  elseif ( (minloc(n,1)==3) .and. (mod(n(1),n(3))==0 .and. mod(n(2),n(3))==0) ) then
    ...
    write(err_buf__,*) 'Number of tiles in other dimensions must be multiple of number';call err__("tiles/topology/os-hilbert.f03",954)
    write(err_buf__,*) 'of tiles in smallest dimension';call err__("tiles/topology/os-hilbert.f03",955)
    call abort_program()
  endif
