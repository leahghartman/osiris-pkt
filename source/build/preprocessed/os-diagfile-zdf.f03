# 1 "dutil/os-diagfile-zdf.f03"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 467 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "dutil/os-diagfile-zdf.f03" 2
...
! --------------------------------------------------------------------------------------------------
# 671 "dutil/os-diagfile-zdf.f03"
# 1 "dutil/os-diagfile-zdf.f03" 1
# 712 "dutil/os-diagfile-zdf.f03"
!---------------------------------------------------------------------------------------------------
! Template Function definitions
!---------------------------------------------------------------------------------------------------

subroutine add_dataset_1d_r4_zdf( this, name, buffer )
  ...
  dset % name = name
  dset % data_type = diag_zdf_type(zdf_float32)
  dset % ndims = 1
  do i = 1, 1
...
end subroutine add_dataset_1d_r4_zdf
# 672 "dutil/os-diagfile-zdf.f03" 2
...
subroutine add_dataset_2d_r4_zdf( this, name, buffer )
...
end subroutine add_dataset_2d_r4_zdf
# 679 "dutil/os-diagfile-zdf.f03" 2
...
subroutine add_dataset_3d_r4_zdf( this, name, buffer )
...
end subroutine add_dataset_3d_r4_zdf
# 686 "dutil/os-diagfile-zdf.f03" 2
...
subroutine add_dataset_1d_r8_zdf( this, name, buffer )
  ...
  dset % name = name
  dset % data_type = diag_zdf_type(zdf_float64)
  dset % ndims = 1
  do i = 1, 1
    dset % count(i) = size(buffer, i)
  enddo
...
end subroutine add_dataset_1d_r8_zdf
# 693 "dutil/os-diagfile-zdf.f03" 2
...
subroutine add_dataset_2d_r8_zdf( this, name, buffer )
...
end subroutine add_dataset_2d_r8_zdf
# 700 "dutil/os-diagfile-zdf.f03" 2
...
subroutine add_dataset_3d_r8_zdf( this, name, buffer )
...
end subroutine add_dataset_3d_r8_zdf
# 707 "dutil/os-diagfile-zdf.f03" 2
