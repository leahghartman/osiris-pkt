# 1 "emf/diagnostics/os-emf-diagnostics.f03"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 467 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "emf/diagnostics/os-emf-diagnostics.f03" 2
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
# 6 "emf/diagnostics/os-emf-diagnostics.f03" 2
...
# 7 "emf/diagnostics/os-emf-diagnostics.f03" 2
...
!-----------------------------------------------------------------------------------------
    ...
    if ( if_report( rep, tstep ) ) then
       ...
       select case ( rep%quant )
         ...
         case ( p_charge_cons )
          ...
          write(err_buf__,*) "Charge conservation diagnostic temporarily disabled";call err__("emf/diagnostics/os-emf-diagnostics.f03",264)
          call abort_program()
  ...
  if( this%diag%if_use_boosted_diag ) then
    ...
    call this%diag%boosted_diag%extract( tstep, t, grid, g_space, this%e, this%b )
