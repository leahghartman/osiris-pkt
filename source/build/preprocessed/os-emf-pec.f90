# 1 "emf/boundary/os-emf-pec.f90"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 467 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "emf/boundary/os-emf-pec.f90" 2
!-----------------------------------------------------------------------------------------
...
# 11 "emf/boundary/os-emf-pec.f90" 2
# 1 "./os-config.h" 1
...
# 12 "emf/boundary/os-emf-pec.f90" 2
...
# 19 "./memory/memory.h"
use memory
# 16 "emf/boundary/os-emf-pec.f90" 2
