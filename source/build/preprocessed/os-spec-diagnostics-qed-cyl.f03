# 1 "qed-cyl/os-spec-diagnostics-qed-cyl.f03"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 467 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "qed-cyl/os-spec-diagnostics-qed-cyl.f03" 2
# 1 "./os-config.h" 1
...
# 2 "qed-cyl/os-spec-diagnostics-qed-cyl.f03" 2
...
# 3 "qed-cyl/os-spec-diagnostics-qed-cyl.f03" 2

module m_species_diagnostics_qedcyl
...
# 19 "./memory/memory.h"
use memory
# 7 "qed-cyl/os-spec-diagnostics-qed-cyl.f03" 2
...
real(p_double), parameter :: const_e = 1.602176634d-19 ! J s
real(p_double), parameter :: const_c = 2.997924580d+08 ! m/s
real(p_double), parameter :: const_m = 9.109383701d-31 ! kg

interface radspect_hist_qedcyl
    module procedure radspect_hist_qedcyl
end interface

interface report_radspect_qedcyl
    module procedure report_radspect_qedcyl
end interface

interface emission_chi_hist_qedcyl
    module procedure emission_chi_hist_qedcyl
end interface

interface report_chi_emit_qedcyl
    module procedure report_chi_emit_qedcyl
end interface

interface radanglespect_hist_qedcyl
    module procedure radanglespect_hist_qedcyl
end interface

interface report_radanglespect_qedcyl
    module procedure report_radanglespect_qedcyl
end interface

interface radsphere_hist_qedcyl
    module procedure radsphere_hist_qedcyl
end interface

interface report_radsphere_qedcyl
    module procedure report_radsphere_qedcyl
end interface

interface detector_hist_qedcyl
    module procedure detector_hist_qedcyl
end interface

interface report_detector_qedcyl
    module procedure report_detector_qedcyl
end interface

interface n_emit_hist_qedcyl
    module procedure n_emit_hist_qedcyl
end interface

interface report_n_emit_qedcyl
    module procedure report_n_emit_qedcyl
end interface

interface chi_hist_qedcyl
    module procedure chi_hist_qedcyl
end interface

interface report_chi_qedcyl
    module procedure report_chi_qedcyl
end interface

public :: radspect_hist_qedcyl, report_radspect_qedcyl, radanglespect_hist_qedcyl, &
            report_radanglespect_qedcyl, n_emit_hist_qedcyl, report_n_emit_qedcyl, &
            chi_hist_qedcyl, report_chi_qedcyl, emission_chi_hist_qedcyl, &
            report_chi_emit_qedcyl, radsphere_hist_qedcyl, report_radsphere_qedcyl, &
            detector_hist_qedcyl, report_detector_qedcyl
...
subroutine radspect_hist_qedcyl(this, p_g, q_g)
...
end subroutine radspect_hist_qedcyl

subroutine report_radspect_qedcyl( this, no_co, tstep, t )
    ...
    if (test_if_report( tstep, this%ndump_fac_radspect )) then
        ...
        radspect_buffer = this%radspect * dxvol * 2.0d0 * pi

        ! spectrum in plasma units
...
end subroutine report_radspect_qedcyl

subroutine emission_chi_hist_qedcyl(this, eta, chi_g, q_g)
...
end subroutine emission_chi_hist_qedcyl

subroutine report_chi_emit_qedcyl( this, no_co, tstep, t )
...
end subroutine report_chi_emit_qedcyl

subroutine radanglespect_hist_qedcyl(this, pph, q_g)
...
end subroutine radanglespect_hist_qedcyl

subroutine report_radanglespect_qedcyl( this, no_co, tstep, t )
...
end subroutine report_radanglespect_qedcyl

subroutine radsphere_hist_qedcyl(this, pph, q_g)
    use m_random
...
end subroutine radsphere_hist_qedcyl

subroutine report_radsphere_qedcyl( this, no_co, tstep, t )
...
end subroutine report_radsphere_qedcyl

subroutine detector_hist_qedcyl(this, pph, q_g)
    use m_random
...
end subroutine detector_hist_qedcyl

subroutine report_detector_qedcyl( this, no_co, tstep, t )
...
end subroutine report_detector_qedcyl

subroutine n_emit_hist_qedcyl(this, ix)
...
end subroutine n_emit_hist_qedcyl


subroutine report_n_emit_qedcyl( this, g_space, grid, no_co, tstep, t )
...
end subroutine report_n_emit_qedcyl

subroutine chi_hist_qedcyl(this, ix, q, eta)
...
end subroutine chi_hist_qedcyl

subroutine report_chi_qedcyl( this, g_space, grid, no_co, tstep, t )
    ...
    if (test_if_report( tstep, this%ndump_fac_chi )) then
        ...
        info%fileLabel = ''
        info%path = trim(path_mass) // 'QED' // p_dir_sep // 'chi-grid' // &
        p_dir_sep // trim(this%name) // p_dir_sep
...
end subroutine report_chi_qedcyl

end module m_species_diagnostics_qedcyl

!------------------------------------------------------------------------------------------
subroutine report_spec_qedcyl( this, emf, g_space, grid, no_co, tstep, t, tmin, send_msg, recv_msg )
!-----------------------------------------------------------------------------------------
    ...
    use m_species_cyl_modes, only : deposit_quant_cyl_modes, p_charge_cyl_m
    ...
    call report_radspect_qedcyl( this, no_co, tstep, t)
    call report_radanglespect_qedcyl( this, no_co, tstep, t)
    call report_n_emit_qedcyl( this, g_space, grid, no_co, tstep, t)
    call report_radsphere_qedcyl( this, no_co, tstep, t)
    call report_detector_qedcyl( this, no_co, tstep, t)
    call report_chi_qedcyl( this, g_space, grid, no_co, tstep, t)
    call report_chi_emit_qedcyl( this, no_co, tstep, t)
    ...
    if (this%bremsstrahlung_info%if_bremsstrahlung ) then
        ...
        call cleanup( this % bremsstrahlung_info % rho_ion_cyl_m )
        call deposit_quant_cyl_modes( this%bremsstrahlung_info%ion_cyl_m, grid, no_co, this % bremsstrahlung_info % rho_ion_cyl_m, this % bremsstrahlung_info % rho_ion, p_charge_cyl_m, send_msg, recv_msg )
    end if
    ...
    if (this%trident_coul_info%if_trident_coul ) then
        ...
        call cleanup( this % trident_coul_info % rho_ion_cyl_m )
        call deposit_quant_cyl_modes( this%trident_coul_info%ion_cyl_m, grid, no_co, this % trident_coul_info % rho_ion_cyl_m, this % trident_coul_info % rho_ion, p_charge_cyl_m, send_msg, recv_msg )
    end if

end subroutine report_spec_qedcyl
!-----------------------------------------------------------------------------------------
...
!-----------------------------------------------------------------------------------------
    ...
    if (test_if_report( tstep, this%ndump_fac_rad )) then
        ...
        energy_rad = abs(this%energy_rad * this%rqm * dxvol*2.*pi)
...
end subroutine report_energy_rad_spec_qedcyl
!-----------------------------------------------------------------------------------------
...
end subroutine report_pairs_ct_spec_qedcyl
