# 1 "spec/os-spec-radcool.f90"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 467 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "spec/os-spec-radcool.f90" 2
...
subroutine advance_deposit_radcool( this, emf, jay, t, tstep, omega_p0, tid, n_threads )
  ...
  if ( t < this%push_start_time ) return
   ...
   case default
      ...
      case default
         write(err_buf__,*) 'Not implemented for x_dim = ',p_x_dim;call err__("spec/os-spec-radcool.f90",127)
   ...
   case ( p_cylindrical_b )
      ...
      write(err_buf__,*) 'Not implemented for cylindrical geometry';call err__("spec/os-spec-radcool.f90",136)
      call abort_program(p_err_invalid)
