...
subroutine DEP_CURRENT_1D( jay, dxi, xnew, ixold, xold, q, rgamma, u, np, dt )
  ...
  real(p_k_fld), dimension(P0:P1) :: pw1
  real(p_k_fld), dimension(L0:L1) :: wl1
  ...
  do i=1,nsplit
     ...
     call WL( qnx, x0, x1, wl1 )

     do k1 = P0, P1
       pw1(k1) = 0.5_p_k_fld * (S0x(k1)+S1x(k1))
     enddo
     ...
     do k1 = P0, P1
       jay%f1(2,ix+k1) = jay%f1(2,ix+k1) + qvy * pw1(k1)
       jay%f1(3,ix+k1) = jay%f1(3,ix+k1) + qvz * pw1(k1)
     enddo
...
! Accumulate 1 component at a time
...
subroutine DEP_CURRENT_2D(  jay, dxi, xnew, ixold, xold, q, rgamma, u, np, dt )
  ...
  real(p_k_fld), dimension(L0:L1) :: wl1, wl2
  ...
  do i=1,nsplit
    ...
    do k2 = P0,P1
      do k1 = L0,L1
        jay%f2(1,ix+k1,jx+k2) = jay%f2(1,ix+k1,jx+k2) + wl1(k1) * wp1(k2)
      enddo
    enddo
    ...
    do k2 = L0,L1
      do k1= P0,P1
         jay%f2(2,ix+k1,jx+k2) = jay%f2(2,ix+k1,jx+k2) + wl2(k2) * wp2(k1)
      enddo
    enddo
    ...
    do k2 = P0,P1
      do k1 = P0,P1
         ...
         jay%f2(3,ix+k1,jx+k2) = jay%f2(3,ix+k1,jx+k2) + qvz * ( tmp1 + 0.5_p_k_fld * tmp2 )
      enddo
    enddo
  ...
  jnorm3 = real( jay%dx_(3) / dt / 3, p_k_fld )
   ...
   do i=1,nsplit
     ...
     do k3 = P0, P1
       do k2 = P0, P1
         do k1 = L0, L1
            jay%f3(1,ix+k1,jx+k2,kx+k3) = jay%f3(1,ix+k1,jx+k2,kx+k3) + wl1(k1) * wp1(k2,k3)
         enddo
       enddo
     enddo
     ...
     do k3 = P0, P1
       do k2 = L0, L1
         do k1 = P0, P1
            jay%f3(2,ix+k1,jx+k2,kx+k3) = jay%f3(2,ix+k1,jx+k2,kx+k3) + wl2(k2) * wp2(k1,k3)
         enddo
       enddo
     enddo
     ...
     do k3 = L0, L1
       do k2 = P0, P1
         do k1 = P0, P1
            jay%f3(3,ix+k1,jx+k2,kx+k3) = jay%f3(3,ix+k1,jx+k2,kx+k3) + wl3(k3) * wp3(k1,k2)
         enddo
       enddo
     enddo
