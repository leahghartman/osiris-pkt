...
subroutine comp_select_sphe_det( this )
  ...
  if (this%approx) then
    ...
    case(8)
      this % fill_emf_loc => calc_comp_approx_B1
    case(9)
      this % fill_emf_loc => calc_comp_approx_E1B1
    case(10)
      this % fill_emf_loc => calc_comp_approx_E2B1
    case(11)
      this % fill_emf_loc => calc_comp_approx_E1E2B1
    case(12)
      this % fill_emf_loc => calc_comp_approx_E3B1
    case(13)
      this % fill_emf_loc => calc_comp_approx_E1E3B1
    case(14)
      this % fill_emf_loc => calc_comp_approx_E2E3B1
    case(15)
      this % fill_emf_loc => calc_comp_approx_E1E2E3B1
    case(16)
      this % fill_emf_loc => calc_comp_approx_B2
    case(17)
      this % fill_emf_loc => calc_comp_approx_E1B2
    case(18)
      this % fill_emf_loc => calc_comp_approx_E2B2
    case(19)
      this % fill_emf_loc => calc_comp_approx_E1E2B2
    case(20)
      this % fill_emf_loc => calc_comp_approx_E3B2
    case(21)
      this % fill_emf_loc => calc_comp_approx_E1E3B2
    case(22)
      this % fill_emf_loc => calc_comp_approx_E2E3B2
    case(23)
      this % fill_emf_loc => calc_comp_approx_E1E2E3B2
    case(24)
      this % fill_emf_loc => calc_comp_approx_B1B2
    case(25)
      this % fill_emf_loc => calc_comp_approx_E1B1B2
    case(26)
      this % fill_emf_loc => calc_comp_approx_E2B1B2
    case(27)
      this % fill_emf_loc => calc_comp_approx_E1E2B1B2
    case(28)
      this % fill_emf_loc => calc_comp_approx_E3B1B2
    case(29)
      this % fill_emf_loc => calc_comp_approx_E1E3B1B2
    case(30)
      this % fill_emf_loc => calc_comp_approx_E2E3B1B2
    case(31)
      this % fill_emf_loc => calc_comp_approx_E1E2E3B1B2
    case(32)
      this % fill_emf_loc => calc_comp_approx_B3
    case(33)
      this % fill_emf_loc => calc_comp_approx_E1B3
    case(34)
      this % fill_emf_loc => calc_comp_approx_E2B3
    case(35)
      this % fill_emf_loc => calc_comp_approx_E1E2B3
    case(36)
      this % fill_emf_loc => calc_comp_approx_E3B3
    case(37)
      this % fill_emf_loc => calc_comp_approx_E1E3B3
    case(38)
      this % fill_emf_loc => calc_comp_approx_E2E3B3
    case(39)
      this % fill_emf_loc => calc_comp_approx_E1E2E3B3
    case(40)
      this % fill_emf_loc => calc_comp_approx_B1B3
    case(41)
      this % fill_emf_loc => calc_comp_approx_E1B1B3
    case(42)
      this % fill_emf_loc => calc_comp_approx_E2B1B3
    case(43)
      this % fill_emf_loc => calc_comp_approx_E1E2B1B3
    case(44)
      this % fill_emf_loc => calc_comp_approx_E3B1B3
    case(45)
      this % fill_emf_loc => calc_comp_approx_E1E3B1B3
    case(46)
      this % fill_emf_loc => calc_comp_approx_E2E3B1B3
    case(47)
      this % fill_emf_loc => calc_comp_approx_E1E2E3B1B3
    case(48)
      this % fill_emf_loc => calc_comp_approx_B2B3
    case(49)
      this % fill_emf_loc => calc_comp_approx_E1B2B3
    case(50)
      this % fill_emf_loc => calc_comp_approx_E2B2B3
    case(51)
      this % fill_emf_loc => calc_comp_approx_E1E2B2B3
    case(52)
      this % fill_emf_loc => calc_comp_approx_E3B2B3
    case(53)
      this % fill_emf_loc => calc_comp_approx_E1E3B2B3
    case(54)
      this % fill_emf_loc => calc_comp_approx_E2E3B2B3
    case(55)
      this % fill_emf_loc => calc_comp_approx_E1E2E3B2B3
    case(56)
      this % fill_emf_loc => calc_comp_approx_B1B2B3
    case(57)
      this % fill_emf_loc => calc_comp_approx_E1B1B2B3
    case(58)
      this % fill_emf_loc => calc_comp_approx_E2B1B2B3
    case(59)
      this % fill_emf_loc => calc_comp_approx_E1E2B1B2B3
    case(60)
      this % fill_emf_loc => calc_comp_approx_E3B1B2B3
    case(61)
      this % fill_emf_loc => calc_comp_approx_E1E3B1B2B3
    case(62)
      this % fill_emf_loc => calc_comp_approx_E2E3B1B2B3
    case(63)
      this % fill_emf_loc => calc_comp_approx_E1E2E3B1B2B3
#endif
    case default
