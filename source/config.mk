...
LDF  = $(LDFLAGS) $(H5_FLINKFLAGS) $(MPI_FLINKFLAGS) $(CUDA_FLINKFLAGS) $(SION_FLINKFLAGS)
...
ifneq ("$(PY_FCOMPILEFLAGS)","")
  FPPF += -DENABLE_PY_UTIL
  F90F += $(PY_FCOMPILEFLAGS)
  CF   += $(PY_FCOMPILEFLAGS)
  LDF  += $(PY_FLINKFLAGS)
endif
...
# Compiler and linker flags needed for CUDA code
ifdef ENABLE_CUDA
  NVCCF = $(FPPF) $(NVCCFLAGS_$(COMPILATION_TYPE))
  NVCCLDF = $(CUDA_CLINKFLAGS_$(COMPILATION_TYPE))
  GPUFILE = gpu.dlink.o
else
  GPUFILE = 
endif
