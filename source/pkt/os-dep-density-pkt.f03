...
#define DEP_DENSITY_1D ONAME( dep_density_1d, ORDER )
#define DEP_DENSITY_2D ONAME( dep_density_2d, ORDER )
#define DEP_DENSITY_3D ONAME( dep_density_3d, ORDER )

#define GAT_DENSITY_1D ONAME( gat_density_1d, ORDER )
#define GAT_DENSITY_2D ONAME( gat_density_2d, ORDER )
#define GAT_DENSITY_3D ONAME( gat_density_3d, ORDER )

#define GAT_DENSITY_GRAD_1D ONAME( gat_density_grad_1d, ORDER )
#define GAT_DENSITY_GRAD_2D ONAME( gat_density_grad_2d, ORDER )
#define GAT_DENSITY_GRAD_3D ONAME( gat_density_grad_3d, ORDER )

#define SPLINE ONAME( spline, ORDER )
#define SPLINE_DERIV ONAME( dspline, ORDER )
...
!! @param q              Particle charges (weights)
!! @param np             Number of particles to deposit
subroutine DEP_DENSITY_1D(density, ix, x, q, p, np, photon_density_grid)
...
!! @param q              Particle charges (weights)
!! @param np             Number of particles to deposit
subroutine DEP_DENSITY_2D(density, ix, x, q, p, np)
...
!! @param q              Particle charges (weights)
!! @param np             Number of particles to deposit
subroutine DEP_DENSITY_3D(density, ix, x, q, np)
...
!! @param q              Particle charges (weights)
!! @param np             Number of particles to deposit
subroutine GAT_DENSITY_1D(den_part, den_grid, ix, x, np)
...
!! @param q              Particle charges (weights)
!! @param np             Number of particles to deposit
subroutine GAT_DENSITY_2D(den_part, den_grid, ix, x, np, fc)
...
!! @param q              Particle charges (weights)
!! @param np             Number of particles to deposit
subroutine GAT_DENSITY_3D(den_part, den_grid, ix, x, np)
...
end subroutine GAT_DENSITY_3D
!-------------------------------------------------------------------------------

subroutine GAT_DENSITY_GRAD_1D(grad_part, den_grid, ix, x, dx, np)
   ...
   integer :: ip, k1
   real(p_k_part) :: x0
   real(p_k_fld), dimension(LP:UP) :: w1p
...
end subroutine GAT_DENSITY_GRAD_1D

subroutine GAT_DENSITY_GRAD_2D(grad_part, den_grid, ix, x, np)
   ...
   real(p_k_part) :: x0, y0
   real(p_k_fld), dimension(LP:UP) :: w1, w2
   real(p_k_fld), dimension(LP:UP) :: w1p, w2p
...
end subroutine GAT_DENSITY_GRAD_2D

subroutine GAT_DENSITY_GRAD_3D(grad_part, den_grid, ix, x, np)
   ...
   real(p_k_part) :: x0, y0, z0
   real(p_k_fld), dimension(LP:UP) :: w1, w2, w3
   real(p_k_fld), dimension(LP:UP) :: w1p, w2p, w3p
...
end subroutine GAT_DENSITY_GRAD_3D

!-------------------------------------------------------------------------------

! Clear template definitions

#undef DEP_DENSITY_1D
#undef DEP_DENSITY_2D
#undef DEP_DENSITY_3D

#undef GAT_DENSITY_1D
#undef GAT_DENSITY_2D
#undef GAT_DENSITY_3D

#undef GAT_DENSITY_GRAD_1D
#undef GAT_DENSITY_GRAD_2D
#undef GAT_DENSITY_GRAD_3D
