...
#   System:    Mac OS X 
#   Compilers: GNU family ( gfortran ) for FORTRAN and LLVM (clang) for C.  
#   GNU Fortran, HDF5, and MPI are all installed via Homebrew as tested
##########################################################################################
...
H5_FLINKFLAGS    = -L$(H5_ROOT)/lib -lhdf5_fortran -lhdf5 -lz -lm -L/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/lib

# Uncomment the following if HDF5 supports parallel MPIIO
# H5_HAVE_PARALLEL = 1
CONDA_ROOT = /opt/anaconda3
PY_FCOMPILEFLAGS = -I$(CONDA_ROOT)/include/python3.7m
PY_FLINKFLAGS = -L$(CONDA_ROOT)/lib -lpython3.7m -Wl,-rpath,$(CONDA_ROOT)/lib
